...
def _build_dynamic_interview_prompt(
    ...
    system_prompt = (
        ...
        "  - Make the majority of questions (at least 70%) about **theoretical and conceptual technical depth** required by the JD: programming languages, frameworks, libraries, operating systems, computer networks, databases, data structures & algorithms, system-design concepts, data skills, tools, platforms, and domain knowledge that appear in the JD.\n"
        "  - Prefer \"explain how X works\", \"when would you choose A vs B\", \"walk me through the architecture / design\" style questions over writing full code solutions.\n"
        "  - You may still include a small number of coding / SQL questions when the JD clearly demands hands-on implementation, but keep JD mode primarily focused on **knowledge, reasoning, trade-offs, and how the candidate would apply these skills on the job**.\n"
